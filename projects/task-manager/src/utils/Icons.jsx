export function IconListTask(props) {
    return (
      <svg
        fill="currentColor"
        viewBox="0 0 16 16"
...
export function IconBxsTrash(props) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="currentColor"
...
export function CloseIcon(props){
  return (
    <svg className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" {...props}>
...
export function IconCircleFill(props) {
  return (
    <svg
      fill="currentColor"
      viewBox="0 0 16 16"
...
export function IconAddR(props) {
  return (
...
export function IconClipboard2Fill(props) {
  return (
    <svg
      fill="currentColor"
      viewBox="0 0 16 16"
    ...
    >
      ...
      <path d="M3.5 1h.585A1.498 1.498 0 004 1.5V2a1.5 1.5 0 001.5 1.5h5A1.5 1.5 0 0012 2v-.5c0-.175-.03-.344-.085-.5h.585A1.5 1.5 0 0114 2.5v12a1.5 1.5 0 01-1.5 1.5h-9A1.5 1.5 0 012 14.5v-12A1.5 1.5 0 013.5 1z" />
    </svg>
  )
}
...
export function IconCalendarDates(props) {
  return (
    <svg fill="none" viewBox="0 0 24 24" height="1em" width="1em" {...props}>
      <path
        fill="currentColor"
...
export function IconBxsBookOpen(props) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="currentColor"
...
export function IconDocumentDelete(props) {
  return (
    <svg
      baseProfile="tiny"
      viewBox="0 0 24 24"
